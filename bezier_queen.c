...
void queen()
{
	...
	// Control points
	/*double Ax = 1.0; double Ay = 1.0;// double Az = 1.0;
	double Bx = 1.7; double By = 1.5;// double Bz = 1.0;
	double Cx = 1.0; double Cy = 3.0;// double Cz = -1.0;*/
	
	/*double Ax = px+1.0, Ay = py+1.0;// double Az = 1.0;
	double Bx = px+1.7, By = py+1.5;// double Bz = 1.0;
	double Cx = px+1.2, Cy = py+3.5;// double Cz = -1.0;*/
